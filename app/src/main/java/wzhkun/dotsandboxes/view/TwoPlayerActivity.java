...
public abstract class TwoPlayerActivity extends Activity implements PlayersStateView {
    ...
    protected void initPlayersDisplayView() {
        ...
        currentPlayerPointer = (ImageView
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (currentPlayer == players[0]) {
                    ...
                    currentPlayerPointer.setImageResource(R.mipmap.a1);
                } else {
                    player2state.setText("Thinking");
                    player1state.setText("Waiting");
                    currentPlayerPointer.setImageResource(R.mipmap.a2);
                }
    ...
    private void startGame() {
        ...
        currentPlayer = players[indexOfPlayerFirstToMove];
