...
@SuppressLint("ClickableViewAccessibility") 
	...
	protected void onDraw(Canvas canvas) {
		...
		float radius = SBoard.radius * min;
		float start = SBoard.start * min;
		float stop = SBoard.stop * min;
		float add1 = SBoard.add1 * min;
		float add2 = SBoard.add2 * min;
		float add4 = SBoard.add4 * min;
		float add5 = SBoard.add5 * min;
		float add6 = SBoard.add6 * min;
